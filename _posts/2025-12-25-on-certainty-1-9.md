...
"알다"라는 개념과 "확신하다"라는 개념의 차이는 그다지 큰 중요성이 없다 — "나는 안다"가 "나는 틀릴 수 *없다*"를 의미해야 하는 경우를 제외하고는. 예를 들어 법정에서는 모든 증언에서 "나는 안다" 대신 "나는 확신한다"라고 말할 수 있을 것이다. 그렇다, 거기서 "나는 안다"가 금지되어 있다고 상상할 수도 있다. [*빌헬름 마이스터*에서 "너는 안다" 또는 "너는 알았다"가 "너는 확신했다"의 의미로 사용되는 구절이 있는데, 그가 알았던 것과는 사정이 달랐기 때문이다.]
